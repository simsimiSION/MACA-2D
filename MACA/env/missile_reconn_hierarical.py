...
class MissileReconnHieraricalEnv(MultiAgentEnv):
    def __init__(self, config):
        ...
        self.allies = [ReconnaissanceFighter(args) for _ in range(args.env.n_ally_reconn)] + \
                      [MissileFighter(args) for _ in range(args.env.n_ally_missile)]
                      
        self.enemies = [ReconnaissanceFighter(args) for _ in range(args.env.n_enemy_reconn)] + \
                       [MissileFighter(args) for _ in range(args.env.n_enemy_missile)]
